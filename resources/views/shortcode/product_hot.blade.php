                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="lp-item">
                                ...
                                <div class="lp-text">
                                    <div class="box-text">
                                        <h6><a href="{{$item->slug.'.html'}}">{{$item->name}}</a></h6>
                                        <img src="{{ asset('img/arrow-up.png')}}" alt="" />
                                    </div>
                                    <a href="{{$item->slug.'.html'}}">Khám phá <img src="{{ asset('img/arrow-up.png')}}" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="row g-3">
            <div class="col-md-5">
                <div class="img-about">
                    ...
                    <img src="	{{asset($posts_gt->image)}}" alt="">
                </div>
            </div>
            <div class="col-md-7">
                <div class="box-text-about offset-lg-1">
                    ...
                    <div class="content-about">
                        {!! htmlspecialchars_decode($posts_gt->content) !!}
                    </div>
                    {{-- {!! substr(htmlspecialchars_decode($posts_gt->content),0,600) !!} --}}
                
                   <p> <a href="{{ url('gioi-thieu')}}">tìm hiểu thêm <img src="{{ asset('img/bi_arrow-up.png')}}" alt="" /></a></p>
                </div>
