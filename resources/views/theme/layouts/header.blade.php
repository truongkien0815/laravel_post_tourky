...
<div class="humberger-menu-wrapper">
    ...
    <div class="hw-menu mobile-menu">
        <ul>
            ...
            <li><a href="{{url('quy-trinh')}}">quy trình</a></li>
    ...
    <div class="hw-social">
        <a href="{{ setting_option('facebook')}}"><i class="fa-brands fa-facebook-f"></i></a>
        <a href="{{ setting_option('instagram')}}"><i class="fa-brands fa-instagram"></i></a>
        <a href="{{ setting_option('twitter')}}"><i class="fa-brands fa-twitter"></i></a>
        <a href="{{ setting_option('pinterest')}}"><i class="fa-brands fa-pinterest-p"></i></a>
        <a href="{{ setting_option('youtube')}}"><i class="fa-brands fa-youtube"></i></a>
    </div>
                ...
                <div class="col-md-9 neo_add">
                    <div class="row">
                        <div class="col-md-4 topper d-flex align-items-center mb-3 mb-md-0">
                            ...
                            <div class="text">
                                {!! htmlspecialchars_decode($time_work) !!}
                        ...
                        <div class="col-md-4 topper d-flex align-items-center mb-3 mb-md-0">
                            ...
                            <div class="text">
                                ...
                                {!! htmlspecialchars_decode($header_lienhe) !!}
                              
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="btn-tuvan">
                                <a href="{{ url('admin')}}">Đăng nhập</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="nav-options">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="menu-bottom-right">
                ...
                <div class="searchBox">
                    <form class="searchform" method="get" action="{{ route('search') }}" role="search">
                ...
                {{-- <div class="language-menu">
                    ...
                    <a href="#">
                        <img src="{{ asset('img/vn-lang.png')}}" /> <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown">
                ...
                {{-- <div class="language-menu-2">
                    ...
                    <a href="{{ route('cart') }}">
                        ...
                        <span id="CartCount">{{ Cart::count() }}</span></a>
                </div> --}}
