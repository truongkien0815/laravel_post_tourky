                        ...
                        <form method="post" action="{{route('loginCustomerAction')}}" id="form-login-page" accept-charset="UTF-8">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" placeholder="" id="CustomerEmail" class="form-control" autocorrect="off" autocapitalize="none" autofocus="">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                    <button type="button" class="btn btn-primary mb-3 btn-login-page">@lang('Đăng nhập')</button>
                                    <p class="mb-4">
                                        <a href="{{route('forgetPassword')}}" id="RecoverPassword">Quên mật khẩu?</a> &nbsp; | &nbsp;
                                        <a href="{{ route('registerCustomer') }}" id="customer_register_link">Tạo tài khoản</a>
                                    </p>
                                </div>
                            </div>
                        </form>
