														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
                                                                ...
                                                                <p id="menu-item-target-wrap">
                                                                	<label class="howto" for="custom-menu-item-target"> <span>Target</span>&nbsp;
                                                                		<select id="custom-menu-item-target" class="howto" name="target">
                                                                		    <option value="_self">_Self</option>
                                                                		    <option value="_blank">_Blank</option>
                                                                		</select>
                                                                	</label>
                                                                </p>
                                                                <p id="menu-item-rel-wrap">
                                                                     <label class="howto" for="custom-menu-item-rel"> <span>Rel</span>&nbsp;
                                                                         <select id="custom-menu-item-rel" class="howto" name="rel">
														...
														<ul class="menu ui-sortable" id="menu-to-edit">
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
                                                                    ...
                                                                    <p class="field-css-url description description-wide">
                                                                            	<label class="howto" for="custom-menu-item-target-{{$m->id}}"> <span>Target</span>&nbsp;
                                                                            		<select id="target_menu_{{$m->id}}" class="widefat code edit-menu-item-target" name="target_menu_{{$m->id}}">
                                                                            		    <option value="_self" @if($m->target =='_self') selected @endif >_Self</option>
                                                                            		    <option value="_blank" @if($m->target =='_blank') selected @endif>_Blank</option>
                                                                            		</select>
                                                                            	</label>
                                                                    </p>
                                                                    <p class="field-css-url description description-wide">
                                                                                 <label class="howto" for="custom-menu-item-rel-{{$m->id}}"> <span>Rel</span>&nbsp;
                                                                                     <select id="rel_menu_{{$m->id}}" class="widefat code edit-menu-item-rel" name="rel_menu_{{$m->id}}">
                                                                                         <option value="dofollow" @if($m->rel =='dofollow') selected @endif >Dofollow</option>
                                                                                         <option value="nofollow" @if($m->rel =='nofollow') selected @endif >Nofollow</option>
                                                                                     </select>
                                                                                 </label>
                                                                    </p>
																	@if(!empty($roles))
