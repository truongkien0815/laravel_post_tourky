...
(function ($) {
        ...
        const items = document.querySelectorAll('.category-home');
        ...
        const items2 = document.querySelectorAll('.category-home2');
        ...
        const items3 = document.querySelectorAll('.category-home3');

        items3.forEach(item => {
            item.addEventListener('click', () => {
                // Xóa class 'active' từ tất cả các phần tử
                items3.forEach(i => i.classList.remove('active'));
        ...
        const items4 = document.querySelectorAll('.category-home4');

        items4.forEach(item => {
            item.addEventListener('click', () => {
                // Xóa class 'active' từ tất cả các phần tử
                items4.forEach(i => i.classList.remove('active'));
        ...
        const items5 = document.querySelectorAll('.category-home5');

        items5.forEach(item => {
            item.addEventListener('click', () => {
                // Xóa class 'active' từ tất cả các phần tử
                items5.forEach(i => i.classList.remove('active'));
...
$(document).ready(function() {
    $('#gallery_pdp a').on('click', function(e) {
        e.preventDefault();
        var newImage = $(this).data('image');
        $('#zoom_10').attr('src', newImage);
        $('#gallery_pdp a').removeClass('active');
        $(this).addClass('active');
    });
});
