...
if (!function_exists('sc_config') && !in_array('sc_config', config('helper_except', []))) {
     ...
     * @return  [type]            [return description]
     */
    function sc_config($key = null, $storeId = 0, $default = null)
    {
        ...
        return array_key_exists($key, $allConfig) ? $allConfig[$key] : (array_key_exists($key, sc_config_global()) ? sc_config_global()[$key] : $default);
    }
}
