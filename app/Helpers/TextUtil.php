...
class TextUtil {
    ...
    public static $DOCS_APK  = '/docs/downloads.html';
    public static $EMALL_APK_DOWNLOAD  = '/EMallApp.apk';
    public static $MANAGER_APK_DOWNLOAD  = '/ManagerApp.apk';
    public static $DELIVERY_BOY_APK_DOWNLOAD  = '/DeliveryApp.apk';
