...
jQuery(document).ready(function($) {
  ...
  // console.log(strip_key);
	...
	form_checkout.validate({
          ...
          "shipping-name": "Vui lòng nhập Họ & tên",
              "shipping-phone": "Vui lòng nhập số điện thoại",
              "shipping-email": "Vui lòng nhập Email",
              customer_province: "Vui lòng chọn Tỉnh/Thành phố",
              customer_district: "Vui lòng chọn Quận/Huyện",
              customer_ward: "Vui lòng chọn Phường/xã",
