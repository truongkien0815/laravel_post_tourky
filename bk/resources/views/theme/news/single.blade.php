          ...
          <div class="blog-detail">
            <div class="blog-post">
              ...
              <div class="mt-3">
                ...
                <a class="btn-social bs-pinterest me-2 mb-2" href="tps://www.instagram.com/?url={{ url()->current() }}"><i class="fab fa-pinterest"></i></a>
              </div>
            </div>
          </div>

          <h6 class="text-primary mt-4">@lang('Hoạt động liên quan')</h6>
          <ul class="pl-3">
