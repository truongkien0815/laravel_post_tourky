...
//     return $request->user();
// });
Route::get('/product/loadmore', 'ProductController@loadMore')->name('product.loadmore');
Route::post('/product/show', 'ProductController@show')->name('product.show');
Route::post('/product/showcategoryhome', 'ProductController@showcategoryhome')->name('product.showcategoryhome');
