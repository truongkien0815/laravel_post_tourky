        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<form action="<?php echo e(route('admin.postThemeOption')); ?>" method="POST" id="frm-theme-option" enctype="multipart/form-data">
              		<?php echo csrf_field(); ?>
		              ...
		              <?php 
						...
						<?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<?php if($setting->type == "line"): ?>
								<div class="group_item_theme">
									<div class="icon_change_postion"><i class="fa fa-sort"></i></div>
									<div class="left_item_theme left_genate">
										<input type="text" value="<?php echo e($setting->name); ?>" placeholder="Please enter Name Field"  name="header_option[line][name][]" />
									</div>
									<div class="right_item_theme right_genate">
										<input type="text" class="regular-text" placeholder="Please enter Value Field" name="header_option[line][value][]" value="<?php echo e($setting->content); ?>" />
							...
							<?php elseif($setting->type == "text"): ?>
								<div class="group_item_theme">
									<div class="icon_change_postion"><i class="fa fa-sort"></i></div>
									<div class="left_item_theme left_genate">
										<input type="text" value="<?php echo e($setting->name); ?>" placeholder="Please enter Name Field"  name="header_option[text][name][]" />
									</div>
									<div class="right_item_theme right_genate">
										<textarea class="regular-area" id="header_option_text_<?php echo e($index); ?>" name="header_option[text][value][]" cols="5" rows="5"><?php echo $setting->content; ?></textarea>
									</div>
									<div class="action">
										<input type="button" class="button button-secondary tbl_button_delete_clean" value="Delete" name="delete_tbl">
									</div>
							...
							<?php elseif($setting->type == "editor"): ?>
								<div class="group_item_theme">
									<div class="icon_change_postion"><i class="fa fa-sort"></i></div>
									<div class="left_item_theme left_genate">
										<input type="text" value="<?php echo e($setting->name); ?>" placeholder="Please enter Name Field"  name="header_option[editor][name][]" />
									</div>
									<div class="right_item_theme right_genate">
										<textarea class="regular-area" id="header_option_text_<?php echo e($index); ?>" name="header_option[editor][value][]" cols="5" rows="5"><?php echo htmlspecialchars_decode($setting->content); ?></textarea>
									</div>
									<div class="action">
										<input type="button" class="button button-secondary tbl_button_delete_clean" value="Delete" name="delete_tbl">
									</div>
								...
								<script type="text/javascript">
									jQuery(document).ready(function($) {
										editorQuote('header_option_text_<?php echo e($index); ?>');
									});
								</script>

							<?php elseif($setting->type == "img"): ?>
								<?php echo $__env->make("admin.partials.image-inline", [
...
<div class="inlcude-image" style="display: none;">
		<?php echo $__env->make("admin.partials.image-inline", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$(".right_item_theme").delegate("#create_option","click", function(event) {
         ...
         index = index + 1;
         console.log(index);
         image_input.find('img').attr('src', "<?php echo e(asset('assets/images/placeholder.png')); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\congnghiepnew-call-api\resources\views/admin/setting/theme-option.blade.php ENDPATH**/ ?>