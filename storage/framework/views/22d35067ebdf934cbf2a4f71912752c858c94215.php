    		          	...
    		          	<div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="vi" role="tabpanel" aria-labelledby="vi-tab">
                                    ...
                                    <div class="form-group">
                                        <label for="description">Số view</label>
                                      <input type="number" required name="description" class="form-control slug_slugify" id="" value="<?php echo $description ?? ''; ?>">
                                       
                                    </div>
                                    <div class="form-group">
                                        <label for="content">Nội dung</label>
                                        <textarea id="description" name="content"><?php echo $content ?? ''; ?></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="list_category">
                                ...
                                $id = $id ?? 0;
                                    ...
                                    $categories = App\Model\Category::orderByDESC('sort')->get();
                                ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\congnghiepnew-call-api\resources\views/admin/post/single.blade.php ENDPATH**/ ?>