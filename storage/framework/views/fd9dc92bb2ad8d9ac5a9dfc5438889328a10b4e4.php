...
<div class="humberger-menu-wrapper">
    ...
    <div class="hw-menu mobile-menu">
        <ul>
            ...
            <li><a href="<?php echo e(url('/admin')); ?>">đăng nhập</a></li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-9 neo_add">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="btn-tuvan">
                                <a href="<?php echo e(url('admin')); ?>">Đăng nhập</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php if(!Auth::check()): ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH D:\laragon\www\congnghiepnew-call-api\resources\views/theme/layouts/header.blade.php ENDPATH**/ ?>