              ...
              <tbody>
                ...
                <tr>
                  <td class="header" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:25px 0;text-align:center">
                    <a href="<?php echo e(url('/')); ?>" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#bbbfc3;font-size:19px;font-weight:bold;text-decoration:none" target="_blank">
                      <?php echo e(\App\Libraries\Helpers::get_option_minhnn('name-company')); ?>
                      ...
                      <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;margin:0 auto;padding:0;text-align:center;width:570px">
                        <tbody><tr>
                          <td class="content-cell" align="center" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:15px 15px 5px">
                            <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;line-height:1.5em;margin:0;color:#aeaeae;font-size:12px;text-align:center">&copy;<?php echo e(date('Y')); ?> <?php echo e(\App\Libraries\Helpers::get_option_minhnn('name-company')); ?>. All rights reserved.</p>
                          </td>
                        </tr>
                      </tbody></table>
                    </td>
...
<?php /**PATH D:\laragon\www\congnghiepnew\resources\views/email/layout.blade.php ENDPATH**/ ?>