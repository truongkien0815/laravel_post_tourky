        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 main-col">
                    <div class="mb-4">
                        <form method="post" action="<?php echo e(route('loginCustomerAction')); ?>" id="form-login-page" accept-charset="UTF-8">
                            ...
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <button type="button" class="btn-main mb-3 btn-login-page"><?php echo app('translator')->get('Đăng nhập'); ?></button>
                                <p class="mb-4">
                                    <a href="<?php echo e(route('forgetPassword')); ?>" id="RecoverPassword">Quên mật khẩu?</a> &nbsp; | &nbsp;
                                    <a href="<?php echo e(route('user.register')); ?>" id="customer_register_link">Tạo tài khoản</a>
                                </p>
                            </div>
                        </form>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($templatePath .'.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\congnghiepnew\resources\views/auth/login.blade.php ENDPATH**/ ?>