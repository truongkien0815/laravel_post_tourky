...
?>
						...
						<div class="col-md-3 col-item-cate">
							<div class="line1 pagehigh">
								<div class="innermall square text-center">
									<div class="mall_word">
										<a class="category-home3" data-product-id="<?php echo e($item->id); ?>" href="#sort"><?php echo e($item->name); ?></a>
									</div>
								</div>
							</div>
						</div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						<div class="spinner-border d-none loader3" role="status">
	...
	<?php /**PATH D:\laragon\www\congnghiepnew-call-api\resources\views/shortcode/service_home3.blade.php ENDPATH**/ ?>