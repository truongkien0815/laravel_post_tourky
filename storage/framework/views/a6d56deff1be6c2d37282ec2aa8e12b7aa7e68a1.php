  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(route('index')); ?>"><?php echo e(\App\Libraries\Helpers::get_option_minhnn('site-name')); ?></a>.</strong> All rights reserved. Thiết kế <a href="https://thietkewebnhanh247.com/" target="_blank">Website</a> bởi <a href="https://www.expro.vn/" target="_blank">Expro Việt Nam</a>
  </footer>
  ...
  <div class="modal fade" id="modal-export-customer" tabindex="-1" role="dialog" aria-labelledby="modal-export-customer-label" aria-hidden="true">
    <form action="<?php echo e(route('admin.exportCustomer')); ?>" method="GET" id="export-customer">
  ...
  <div class="modal fade" id="modal-export-order" tabindex="-1" role="dialog" aria-labelledby="modal-export-order-label" aria-hidden="true">
    <form action="<?php echo e(route('admin.exportOrders')); ?>" method="GET" id="export-order">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
...
<!-- ./wrapper -->
<?php /**PATH D:\laragon\www\congnghiepnew-call-api\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>